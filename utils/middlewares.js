...
const checkPermisos = async (req, res, next) => {
    ...
    //console.debug(`permisos_ids ${JSON.stringify(permisos_ids)}\n\n permiso ${JSON.stringify(permiso)}\n\nmetodo ${metodo}\n ruta ${ruta}\npermiso ${permiso}.`);

}



/* console.debug("we are in checkpermisos")
...
const checkSuperusuario = (req, res, next) => {
    console.debug(`req.ususario.roles_id = ${req.ususario.roles_id}`);
